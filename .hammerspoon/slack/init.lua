...
slackModal:bind({'ctrl'}, 'j', nil, focus.mainMessageBox, nil, focus.mainMessageBox)
slackModal:bind({'ctrl'}, 'k', nil, slackDown, nil, slackDown)
slackModal:bind({'ctrl'}, 'i', nil, slackUp, nil, slackUp)
...
slackWatcher = hs.application.watcher.new(function(applicationName, eventType)
  -- print(applicationName, eventType)
